...
function Init(){customSwiper();gsap.set($('.swiper-slide-active .content__subtitle'),{opacity:0,transform:'translate3d(0,15vh,0)',delay:0})
...
let activeslide=gsap.timeline();activeslide.to($('.swiper-pagination-bullet-active').find('.counter'),{duration:0.5,y:0,stagger:0.1,ease:'Power2.easeOut'})
...
let nextslide=gsap.timeline();nextslide.to($('.swiper-pagination-bullet-active').next().find('.counter'),{duration:0.5,y:20,stagger:0.1,ease:'Power2.easeIn'})
...
nextslide.to($('.swiper-slide-active').next().find('.content__subtitle'),{duration:0.5,x:20,opacity:0,delay:0.1,ease:'Power2.easeIn'})},slidePrevTransitionStart:function(){let prevslide=gsap.timeline();prevslide.to($('.swiper-pagination-bullet-active').prev().find('.counter'),{duration:0.5,y:-20,stagger:-0.1,ease:'Power2.easeIn'})
